...
export const DropzonePlain: React.FC<DropzonePlainProps> = ({
    ...
    const isMaxSizeAchieved =
        (!!maxFilesCount && acceptedFiles.length >= maxFilesCount) ||
        (!multiSelect && !!acceptedFiles.length) ||
        (!multiSelect && !!fileRejections.length);
    ...
    const haveDroppedFiles = acceptedFiles.length + fileRejections.length > 0;
            ...
            {showInputOnTop && (
                <DropzoneInput
                    {...{
                        ...
                        iconClassName,
                        icon,
                        disabled: disabled || isProcessing || isMaxSizeAchieved,
                        hideInput: multiSelect ? hideInput : haveDroppedFiles,
                        listType,
                    }}
                />
            )}
