        ...
        <>
            ...
            <div className='relative'>
                <Image
                    ...
                    height={770}
                />
                <div className='absolute top-[50px] left-[50px] right-0 text-[#4D4735]'>
                    <div className='subtitle'>
                        From events to portraits, every frame is an invitation
                        to join us in creating something unforgettable
                    </div>
                </div>
                <div className='bg-blush flex flex-col py-[50px] px-[100px] items-center gap-[20px]'>
                        ...
                        <div className='flex flex-col gap-[50px] info-subtext'>
                            ...
                            <ul className='info-subtext'>
                                <li className='info-subtext'>
                                    View and download your photos in high
                                    quality
                                </li>
                                <li className='info-subtext'>
                            ...
                            <p className='info-subtext'>
                                Your story, beautifully captured — always just
                                one click away.
                            </p>
                        </div>
                        <Image
